public class InventoryFactory {
    ...
    public static void fillInventory(Storage storage) {
        ...
        Component garnet8 = new Bead("garnet6", 8, 1137.43, 45);
        Component obsidian6 = new Bead("blackObsidian6", 6, 985.27, 61);
        Component moon6 = new Bead("moonStone6", 6, 909.18, 61);
        Component moon8 = new Bead("moonStone8", 8, 985.27, 45);
        Component apatite6 = new Bead("apatite6", 6, 909.18, 61);
        Component apatite8 = new Bead("apatite8", 8, 1137.43, 45);
        Component bluey6 = new Bead("blueAmazonite6", 6, 985.27, 61);
        Component amazonite6 = new Bead("mixedAmazonite6", 6, 680.94, 61);
        Component amazonite8 = new Bead("mixedAmazonite8", 8, 1212.08, 45);
        Component tourmaline6 = new Bead("tourmaline6", 6, 680.94, 61);
        Component tourmaline8 = new Bead("tourmaline8", 8, 1354.22, 45);
        Component colorfulTurquise8 = new Bead("colorfulTurqoise8", 8, 864.65, 45);
        Component blackCrackedAgate8 = new Bead("blackCrackedAgate8", 8, 1263.42, 45);
        Component pictureJasper8 = new Bead("pictureJasper8", 8, 1310.79, 45);
        Component cracked8 = new Bead("crackedWhiteStone8", 8, 1106.17, 45);
